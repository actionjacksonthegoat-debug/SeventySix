...
public sealed class QueryBuilder<T>
{
	...
	public static QueryBuilder<T> For(IQueryable<T> query)
	{
...
public static class QueryBuilderExtensions
{
	...
	/// <param name="query">The query to apply the builder to.</param>
	...
	{
		QueryBuilder<T> builder = QueryBuilder<T>.For(query);
