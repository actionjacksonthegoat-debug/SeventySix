...
public interface IUserService
{
	...
	/// ModifiedAt is automatically updated to UTC now.
	/// </remarks>
	...
	/// </remarks>
	public Task<bool> DeleteUserAsync(int id, string deletedBy);
	...
	/// - Sorting: SortBy (Username, Email, CreatedAt) and SortDescending
	///
	/// Returns:
	...
	/// </returns>
	/// <remarks>
	/// This is a bulk operation that updates IsActive and ModifiedAt for all specified users.
	/// More efficient than updating users individually.
	/// </remarks>
	public Task<int> BulkUpdateActiveStatusAsync(IEnumerable<int> userIds, bool isActive, string modifiedBy);
}
