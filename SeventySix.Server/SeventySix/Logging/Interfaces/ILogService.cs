...
public interface ILogService
{
	...
	/// <returns>
	/// A task that represents the asynchronous operation.
	/// The task result is true if the database is accessible; false otherwise.
	/// </returns>
	/// <remarks>
	/// Used by infrastructure health check service to verify database connectivity.
	/// Performs a minimal query to verify the connection is alive.
	/// </remarks>
