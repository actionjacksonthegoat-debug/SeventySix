...
public sealed record ValkeySettings
{
	...
	/// </summary>
	/// <remarks>
	/// When set, StackExchange.Redis validates Valkey's server certificate
	/// against this CA. Used with mTLS for internal Docker communication.
	/// </remarks>
	public string? SslCaCertificate { get; init; }

	/// <summary>
	/// Path to client certificate for mutual TLS authentication.
	/// </summary>
	/// <remarks>
	/// When set, StackExchange.Redis presents this certificate to Valkey
	/// for client authentication. Must be used with
	/// <see cref="SslClientKey"/>.
	/// </remarks>
	public string? SslClientCertificate { get; init; }

	/// <summary>
	/// Path to client private key for mutual TLS authentication.
	/// </summary>
	/// <remarks>
	/// Must be set when <see cref="SslClientCertificate"/> is set.
	/// PEM format, generated by the internal CA script.
	/// </remarks>
	public string? SslClientKey { get; init; }
