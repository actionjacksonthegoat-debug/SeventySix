...
public static class CryptoExtensions
{
	...
	/// <returns>Hex-encoded SHA256 hash (uppercase).</returns>
	...
	/// </summary>
	/// <param name="codeVerifier">The PKCE code verifier to hash.</param>
	/// <returns>Base64URL-encoded SHA256 hash for code challenge.</returns>
	/// <remarks>
