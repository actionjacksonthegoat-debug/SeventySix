// <copyright file="OpenWeatherOptions.cs" company="SeventySix">
...
/// <summary>
/// Configuration options for OpenWeather API integration.
/// </summary>
/// <remarks>
...
public class OpenWeatherOptions
{
	...
	/// </summary>
	public const string SECTION_NAME = "OpenWeather";

	/// <summary>
	/// Gets or sets the OpenWeather API key.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Gets or sets the base URL for OpenWeather API.
	/// </summary>
