...
using SeventySix.TestUtilities.Attributes;
...
/// </summary>
public class OpenWeatherIntegrationTests : ApiPostgreSqlTestBase<Program>, IClassFixture<LocalPostgreSqlFixture>
{
	...
	public OpenWeatherIntegrationTests(LocalPostgreSqlFixture fixture)
		: base(fixture)
	{
