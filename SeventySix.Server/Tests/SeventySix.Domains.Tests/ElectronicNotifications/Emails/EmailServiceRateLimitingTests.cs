// <copyright file="EmailServiceRateLimitingTests.cs" company="SeventySix">
...
/// <summary>
/// Rate limiting unit tests for EmailService.
/// </summary>
/// <remarks>
/// Coverage Focus:
/// - Rate limiting: slot reservation, slot release on connection failure.
/// - Rate limiting: slot stays consumed on Brevo API response (400, 429, 201).
/// - Rate limiting: slot release when timeout occurs.
/// - Rate limiting: warning logged when slot release itself fails.
/// </remarks>
public sealed class EmailServiceRateLimitingTests
{
