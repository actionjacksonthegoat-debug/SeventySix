...
public class OpenWeatherServiceTests
{
	...
	[Fact]
	public async Task GetCurrentWeatherAsync_ValidRequest_ReturnsCurrentWeatherAsync()
	{
		// Arrange
	...
	[Fact]
	public async Task GetCurrentWeatherAsync_NullRequest_ThrowsArgumentNullExceptionAsync()
	{
		// Act & Assert
	...
	[Fact]
	public async Task GetHourlyForecastAsync_ValidRequest_ReturnsHourlyForecastsAsync()
	{
		// Arrange
		WeatherRequest request = new()
		{
	...
	[Fact]
	public async Task GetDailyForecastAsync_ValidRequest_ReturnsDailyForecastsAsync()
	{
		// Arrange
		WeatherRequest request = new()
		{
	...
	[Fact]
	public async Task GetWeatherAlertsAsync_ValidRequest_ReturnsAlertsAsync()
	{
		// Arrange
		WeatherRequest request = new()
		{
	...
	[Fact]
	public async Task GetCompleteWeatherDataAsync_ApiClientThrows_ThrowsExternalServiceExceptionAsync()
	{
		// Arrange
		WeatherRequest request = new()
		{
	...
	[Fact]
	public async Task CanMakeApiCall_DelegatesToApiClientAsync()
	{
		// Arrange
	...
	[Fact]
	public async Task GetRemainingApiQuota_DelegatesToApiClientAsync()
	{
		// Arrange
	...
	[Fact]
	public async Task GetMinutelyForecastAsync_ValidRequest_ReturnsMinutelyForecastsAsync()
	{
		// Arrange
		WeatherRequest request = new()
		{
