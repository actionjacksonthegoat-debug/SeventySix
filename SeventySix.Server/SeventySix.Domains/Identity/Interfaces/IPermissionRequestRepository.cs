...
/// <summary>
/// Repository interface for permission request data access.
/// </summary>
public interface IPermissionRequestRepository
{
	/// <summary>
	/// Gets all permission requests with user info.
	/// </summary>
	...
	/// <summary>
	/// Gets existing roles the user already has (from UserRoles).
	/// </summary>
	/// <remarks>
