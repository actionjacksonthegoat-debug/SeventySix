...
namespace SeventySix.Domains.ElectronicNotifications.Migrations
{
	...
	public partial class V1InitialCreate : Migration
	{
		...
		{
			migrationBuilder.EnsureSchema(name: "ElectronicNotifications");
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					RecipientEmail = table.Column<string>(
						...
						maxLength: 256,
						nullable: false),
					RecipientUserId = table.Column<long>(
						type: "bigint",
						nullable: true),
					TemplateData = table.Column<string>(
						type: "jsonb",
						nullable: false),
					...
					Attempts = table.Column<int>(
						...
						nullable: false,
						defaultValue: 0),
					MaxAttempts = table.Column<int>(
						type: "integer",
						nullable: false,
						defaultValue: 3),
					LastAttemptAt = table.Column<DateTime>(
					...
					SentAt = table.Column<DateTime>(
						type: "timestamp with time zone",
						nullable: true),
					IdempotencyKey = table.Column<Guid>(
						type: "uuid",
						nullable: false),
				},
				constraints: table =>
