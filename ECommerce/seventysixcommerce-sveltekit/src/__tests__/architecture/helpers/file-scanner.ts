...
/**
 * Extracts all import source paths from a TypeScript/Svelte file.
 * Returns the string values from import declarations (e.g., "$lib/server/db").
 */
