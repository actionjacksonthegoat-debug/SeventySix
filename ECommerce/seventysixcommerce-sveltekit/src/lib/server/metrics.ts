/**
 * SvelteKit commerce metrics instance.
 * Creates an OTel metrics set scoped to the "seventysixcommerce-sveltekit" meter.
...
const metricsInstance: CommerceMetrics =
	createCommerceMetrics("seventysixcommerce-sveltekit");
