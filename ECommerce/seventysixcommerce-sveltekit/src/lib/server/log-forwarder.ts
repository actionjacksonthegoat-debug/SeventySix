/**
 * SvelteKit log forwarder instance.
 * Creates a log forwarder scoped to the "seventysixcommerce-sveltekit" source context.
...
const forwarder: LogForwarder =
	createLogForwarder("seventysixcommerce-sveltekit");
