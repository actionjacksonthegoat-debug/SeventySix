#!/usr/bin/env node
/**
 * One-command development startup for SeventySixCommerce TanStack.
...
async function main()
{
	console.log("\n=== Starting SeventySixCommerce (TanStack Start) ===\n");
	...
	const migrationsDir = resolve(stackDir, "src/server/db/migrations");
	if (
	...
	// 6. Start dev server
	console.log("\nStarting dev server at https://localhost:3002 ...\n");
