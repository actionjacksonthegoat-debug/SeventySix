...
import { SvelteLogsPage } from "./svelte-logs";

describe("SvelteLogsPage",
	() =>
	{
		let component: SvelteLogsPage;
		let fixture: ComponentFixture<SvelteLogsPage>;
				...
				items: [
					{
						...
						stackTrace: null,
						sourceContext: "seventysixcommerce-sveltekit",
						requestMethod: null,
						requestPath: null,
						statusCode: null,
						durationMs: null,
		...
		{
			fixture =
				TestBed.createComponent(SvelteLogsPage);
			component =
