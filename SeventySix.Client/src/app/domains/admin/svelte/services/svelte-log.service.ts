...
/**
 * Service for querying SvelteKit-specific logs.
 * Always filters by SvelteKit source context. Read-only — no delete/create.
 */
@Injectable()
export class SvelteLogService
{
	/**
	...
	/**
	 * Queries paged logs filtered to SvelteKit source context.
