...
import { ColorSelectorComponent } from "@sandbox/car-a-lot/components/color-selector/color-selector";
import { DrivingHudComponent } from "@sandbox/car-a-lot/components/driving-hud/driving-hud";
import {
	BUMPER_WIDTH,
	LANDING_ROAD_LENGTH,
	LANDING_ROAD_WIDTH,
...
import { BabylonCanvasComponent } from "@sandbox/shared/components/babylon-canvas/babylon-canvas";
...
@Component(
	{
		...
		imports: [BabylonCanvasComponent, DrivingHudComponent, ColorSelectorComponent],
