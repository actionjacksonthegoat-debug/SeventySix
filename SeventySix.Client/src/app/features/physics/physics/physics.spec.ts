...
describe("Physics", () =>
{
	...
	{
		expect(component.title).toBe("Physics Calculations");
	});
	...
	it("should render title in template", async () =>
	{
		const compiled: HTMLElement = fixture.nativeElement;
		const title: HTMLElement | null = compiled.querySelector("h1");
		expect(title?.textContent).toContain("Physics Calculations");
	});

	it("should render coming soon message", async () =>
	{
		const compiled: HTMLElement = fixture.nativeElement;
	...
	it("should have physics-theme class", async () =>
	{
		const compiled: HTMLElement = fixture.nativeElement;
