...
describe("LogDetailDialogComponent", () =>
{
	...
	beforeEach(async () =>
	{
		...
		mockClipboard =
			jasmine.createSpyObj("Clipboard", ["copy"]);
		dateService =
			new DateService();
	...
	it("should copy log details to clipboard as JSON", (done: DoneFn) =>
	{
	...
	it("should emit delete event and close dialog", (done: DoneFn) =>
	{
