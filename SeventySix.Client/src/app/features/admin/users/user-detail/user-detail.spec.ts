	...
	describe("UpdateUserRequest", () =>
	{
		...
		it("should handle 409 conflict error with refresh option", async () =>
		{
			...
			const errorMutation: MockUserMutation =
				...
				Error,
				{ userId: string | number; user: UpdateUserRequest; },
				unknown>({ isError: true, error: conflictError });
			...
			const snackBarSpy: jasmine.SpyObj<{ onAction: () => Subject<void>; }> =
				...
				{ onAction: () => Subject<void>; }>("MatSnackBarRef", ["onAction"]);
