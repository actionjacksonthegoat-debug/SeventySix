...
import { createSeededRandom } from "./walkthrough/human-interaction.mjs";
import { shouldAvoidDirectNavigation } from "./walkthrough/flow.mjs";
import { retryAsync } from "./walkthrough/reliability.mjs";
import { createPageActions } from "./walkthrough/page-actions.mjs";
...
// ─── Page actions (cursor, scrolling, clicking, navigation) ─────────────────
const {
	sleep,
	enableDemoPointer,
	forceInjectCursor,
