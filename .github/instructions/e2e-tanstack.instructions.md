...
- Port 3012 (app), 5441 (DB) — no conflicts with dev (3002) or Angular E2E (4201)
...
## TanStack-Specific Notes

- Health endpoint is at `/api/healthz` (includes `/api/` prefix, unlike SvelteKit)
